...
| Prijava administratora | Administrator se prijavljuje posebnim računom s proširenim ovlastima | Planirano |
| Kreiranje kviza | Administrator kreira kviz s naslovom i opisom | Planirano |
| Dodavanje pitanja | Administrator dodaje pitanja s ponuđenim odgovorima | Planirano |
| Označavanje točnog odgovora | Administrator označava koji je odgovor točan | Planirano |
...
| Prikaz rezultata | Nakon završetka kviza prikazuju se osvojeni bodovi i postotak | Planirano |
...
| Uređivanje kviza | Administrator može naknadno mijenjati kviz i pitanja | Planirano |
| Brisanje kviza | Administrator može obrisati kviz | Planirano |
